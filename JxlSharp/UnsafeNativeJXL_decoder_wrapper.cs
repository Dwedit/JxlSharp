...
namespace JxlSharp
{
	...
	internal unsafe partial class UnsafeNativeJxl
	{
		...
		internal class JxlDecoderWrapper : IDisposable
		{
			...
			/// <see cref="JxlDecoderSubscribeEvents(JxlDecoder*,System.Int32)" /> can be used again, and it is feasible to leave out
			...
			/// automatically (see <see cref="JxlDecoderSetKeepOrientation(JxlDecoder*,System.Int32)" />).
			...
			/// type of box such as Exif or "xml ". When <see cref="JxlDecoderSetDecompressBoxes(JxlDecoder*,System.Int32)" />
			...
			/// compressed mode. When <see cref="JxlDecoderSetDecompressBoxes(JxlDecoder*,System.Int32)" /> is enabled, the
