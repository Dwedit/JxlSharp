...
namespace JxlSharp
{
	internal static partial class UnsafeNativeJxl
	{
		...
		{
			/// <summary>
			/// CMS-specific data that will be passed to <see cref="F:JxlSharp.UnsafeNativeJxl.JxlCmsInterface.init" />. 
			/// </summary>
			public unsafe void* init_data;

			/// <summary>
			/// Prepares a colorspace transform as described in the documentation of 
			/// <see cref="D:JxlSharp.UnsafeNativeJxl.jpegxl_cms_init_func" />. 
			/// </summary>
			...
			/// <summary>
			/// Executes the transform on a batch of pixels, per <see cref="D:JxlSharp.UnsafeNativeJxl.jpegxl_cms_run_func" />.
			/// </summary>
		...
		internal struct JxlBasicInfo
		{
			...
			/// <summary>
			/// See the description of <see cref="F:JxlSharp.UnsafeNativeJxl.JxlBasicInfo.linear_below" />.
			/// </summary>
			...
			/// functions needs to be called with <see cref="F:JxlSharp.UnsafeNativeJxl.JxlColorProfileTarget.JXL_COLOR_PROFILE_TARGET_DATA" /> to get
		...
		internal struct JxlFrameHeader
		{
			...
			/// For the encoder, this value is ignored and <see cref="M:JxlSharp.UnsafeNativeJxl.JxlEncoderSetFrameName(JxlSharp.UnsafeNativeJxl.JxlEncoderFrameSettings*,System.Byte*)" /> is
			...
			/// required to set this value and it is ignored, <see cref="M:JxlSharp.UnsafeNativeJxl.JxlEncoderCloseFrames(JxlSharp.UnsafeNativeJxl.JxlEncoder*)" /> is
		...
		/// <summary>
		/// The result of <see cref="M:JxlSharp.UnsafeNativeJxl.JxlSignatureCheck(System.Byte*,System.UIntPtr)" />.
		/// </summary>
		...
		/// <summary>
		/// Return value for <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderProcessInput(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" />.
		/// The values from <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_BASIC_INFO" /> onwards are optional informative
		/// events that can be subscribed to, they are never returned if they
		/// have not been registered with <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSubscribeEvents(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Int32)" />.
		/// </summary>
		internal enum JxlDecoderStatus
		{
			...
			/// <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderProcessInput(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" /> call, more input data must be set, by calling 
			/// <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderReleaseInput(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" /> (if input was set previously) and then calling 
			/// <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetInput(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Byte*,System.UIntPtr)" />. <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderReleaseInput(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" /> returns how many bytes
			/// are not yet processed, before a next call to <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderProcessInput(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" />
			...
			/// preview output buffer using <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetPreviewOutBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*,JxlSharp.UnsafeNativeJxl.JxlPixelFormat*,System.Void*,System.UIntPtr)" />. This occurs
			/// if <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_PREVIEW_IMAGE" /> is requested and it is possible to decode a
			...
			/// buffer using <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetDCOutBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*,JxlSharp.UnsafeNativeJxl.JxlPixelFormat*,System.Void*,System.UIntPtr)" />. This occurs if 
			/// <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_DC_IMAGE" /> is requested and it is possible to decode a DC image from
			...
			/// rendering, <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderFlushImage(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" /> should be used.
			/// </summary>
			JXL_DEC_NEED_DC_OUT_BUFFER = 4,
			/// <summary>
			/// The decoder requests an output buffer to store the full resolution image,
			/// which can be set with <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetImageOutBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*,JxlSharp.UnsafeNativeJxl.JxlPixelFormat*,System.Void*,System.UIntPtr)" /> or with 
			/// <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetImageOutCallback(JxlSharp.UnsafeNativeJxl.JxlDecoder*,JxlSharp.UnsafeNativeJxl.JxlPixelFormat*,=FUNC:System.Void(System.Void*,System.UIntPtr,System.UIntPtr,System.UIntPtr,System.Void*),System.Void*)" />. This event re-occurs for new frames if
			...
			/// codestream to fit. <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetJPEGBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Byte*,System.UIntPtr)" /> must be called again to
			/// make room for remaining bytes. This event may occur multiple times
			/// after <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_JPEG_RECONSTRUCTION" />.
			/// </summary>
			JXL_DEC_JPEG_NEED_MORE_OUTPUT = 6,
			/// <summary>
			/// The box contents output buffer is too small. <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetBoxBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Byte*,System.UIntPtr)" />
			/// must be called again to make room for remaining bytes. This event may occur
			/// multiple times after <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_BOX" />.
			/// </summary>
			JXL_DEC_BOX_NEED_MORE_OUTPUT = 7,
			/// <summary>
			/// Informative event by <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderProcessInput(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" />
			...
			/// <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_BASIC_INFO" /> and earlier than any pixel data.
			/// <br /><br />
			...
			/// than <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_BASIC_INFO" /> and earlier than any pixel data.
			/// </summary>
			...
			/// <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_COLOR_ENCODING" /> and before <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_FRAME" />.
			/// </summary>
			JXL_DEC_PREVIEW_IMAGE = 512,
			/// <summary>
			/// Informative event by <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderProcessInput(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" />
			/// "JxlDecoderProcessInput": Beginning of a frame. 
			/// <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderGetFrameHeader(JxlSharp.UnsafeNativeJxl.JxlDecoder*,JxlSharp.UnsafeNativeJxl.JxlFrameHeader*)" /> can be used at this point. A note on frames:
			...
			/// displayed frames, unless <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetCoalescing(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Int32)" /> was set to JXL_FALSE:
			...
			/// <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_COLOR_ENCODING" />, and always earlier than any pixel data. While
			...
			/// <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetDCOutBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*,JxlSharp.UnsafeNativeJxl.JxlPixelFormat*,System.Void*,System.UIntPtr)" /> must be used after getting the basic image
			...
			/// once per frame and always later than <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_FRAME" /> and other header
			...
			/// disabled) is decoded. <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetImageOutBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*,JxlSharp.UnsafeNativeJxl.JxlPixelFormat*,System.Void*,System.UIntPtr)" /> must be used after
			...
			/// <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_DC_IMAGE" />.
			/// </summary>
			JXL_DEC_FULL_IMAGE = 4096,
			/// <summary>
			/// Informative event by <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderProcessInput(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" />
			/// "JxlDecoderProcessInput": JPEG reconstruction data decoded. 
			/// <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetJPEGBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Byte*,System.UIntPtr)" /> may be used to set a JPEG reconstruction buffer
			...
			/// before <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_FULL_IMAGE" />.
			/// </summary>
			...
			/// after this event:
			/// - <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetBoxBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Byte*,System.UIntPtr)" /> and <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderReleaseBoxBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" />
			/// "JxlDecoderReleaseBoxBuffer": set and release a buffer to get the box
			/// data.
			/// - <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderGetBoxType(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Byte*,System.Int32)" /> get the 4-character box typename.
			/// - <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderGetBoxSizeRaw(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.UInt64*)" /> get the size of the box as it appears in
			/// the container file, not decompressed.
			/// - <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetDecompressBoxes(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Int32)" /> to configure whether to get the box
			...
			/// type and decompressed data. <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetDecompressBoxes(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Int32)" /> allows
			/// configuring which data to get. Decompressing requires
			/// Brotli. <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderGetBoxType(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Byte*,System.Int32)" /> has a flag to get the compressed box
			...
			/// <br /><br />
			/// The buffer set with <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetBoxBuffer(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Byte*,System.UIntPtr)" /> must be set again for each
			/// next box to be obtained, or can be left unset to skip outputting this box.
			/// The output buffer contains the full box data when the next <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_BOX" />
			/// event or <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_SUCCESS" /> occurs. <see cref="F:JxlSharp.UnsafeNativeJxl.JxlDecoderStatus.JXL_DEC_BOX" /> occurs for all
			...
			/// XMP or JUMBF, use <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderGetBoxType(JxlSharp.UnsafeNativeJxl.JxlDecoder*,System.Byte*,System.Int32)" /> and check for types "Exif",
			...
			/// reached. When calling <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderFlushImage(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" /> at this point, the flushed
			...
			/// <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderSetProgressiveDetail(JxlSharp.UnsafeNativeJxl.JxlDecoder*,JxlSharp.UnsafeNativeJxl.JxlProgressiveDetail)" /> to configure more fine-grainedness. The
		...
		internal enum JxlEncoderFrameSettingId
		{
			...
			/// <see cref="F:JxlSharp.UnsafeNativeJxl.JxlEncoderFrameSettingId.JXL_ENC_FRAME_SETTING_RESAMPLING" />. The input frame must then be given in the
			...
			/// the factor set with <see cref="F:JxlSharp.UnsafeNativeJxl.JxlEncoderFrameSettingId.JXL_ENC_FRAME_SETTING_RESAMPLING" />.
		...
		/// <br /><br />
		/// Allocated and initialized with <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderCreate(JxlSharp.UnsafeNativeJxl.JxlMemoryManager*)" />().
		/// Cleaned up and deallocated with <see cref="M:JxlSharp.UnsafeNativeJxl.JxlDecoderDestroy(JxlSharp.UnsafeNativeJxl.JxlDecoder*)" />().
		/// </summary>
		[StructLayout(LayoutKind.Sequential, Pack = 8, Size = 1)]
		...
		/// <summary>
		/// Creates an instance of <see cref="T:JxlSharp.UnsafeNativeJxl.JxlDecoder" /> and initializes it.
		...
		/// <returns> pointer to initialized <see cref="T:JxlSharp.UnsafeNativeJxl.JxlDecoder" /> otherwise</returns>
		[DllImport("libjxl.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		[MethodImpl(MethodImplOptions.ForwardRef)]
		...
		/// <summary>
		/// Deinitializes and frees <see cref="T:JxlSharp.UnsafeNativeJxl.JxlDecoder" /> instance.
		/// </summary>
		...
		/// <see cref="M:JxlSharp.UnsafeNativeJxl.JxlResizableParallelRunnerSetThreads(System.Void*,System.UIntPtr)" /> is called.
		/// </summary>
		[DllImport("libjxl.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
		[MethodImpl(MethodImplOptions.ForwardRef)]
